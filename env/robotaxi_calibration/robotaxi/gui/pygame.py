...
from robotaxi_calibration.robotaxi.agent import HumanAgent
from robotaxi_calibration.robotaxi.gameplay.entities import (CellType, SnakeAction, SnakeDirection, ALL_SNAKE_DIRECTIONS, ALL_SNAKE_ACTIONS, SNAKE_GROW, WALL_WARP, Point)
from robotaxi_calibration.robotaxi.gameplay.environment import PLAY_SOUND
...
class PyGameGUI:
    ...
    def __init__(self, save_frames=False, field_size=8, test=False):
        ...
        self.punch_sound = pygame.mixer.Sound('robotaxi_calibration/sound/punch.wav')
        self.begin_sound = pygame.mixer.Sound('robotaxi_calibration/sound/begin.wav')
        self.good_sound = pygame.mixer.Sound('robotaxi_calibration/sound/good.wav')
        self.bad_sound = pygame.mixer.Sound('robotaxi_calibration/sound/road_block_crash.wav')
        self.very_bad_sound = pygame.mixer.Sound('robotaxi_calibration/sound/car_crash.wav')
        self.stuck_sound = pygame.mixer.Sound('robotaxi_calibration/sound/woop.wav')
        self.free_sound = pygame.mixer.Sound('robotaxi_calibration/sound/restart.wav')
        ...
        self.spawn_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/wave.png"),(self.CELL_SIZE, self.CELL_SIZE))
        self.wall_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/forest.png"),(self.CELL_SIZE, self.CELL_SIZE))
        self.good_fruit_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/man.png"),(self.CELL_SIZE*2//3, self.CELL_SIZE*2//3))
        self.bad_fruit_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/road_block.png"),(self.CELL_SIZE*2//3, self.CELL_SIZE*2//3))
        self.lava_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/purple_car.png"),(self.CELL_SIZE, self.CELL_SIZE))
        self.small_crash_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/road_block_broken.png"),(self.CELL_SIZE*2//3, self.CELL_SIZE*2//3))
        self.big_crash_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/broken_purple_car.png"),(self.CELL_SIZE, self.CELL_SIZE*2//3))
        self.reward_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/dollar.png"),(self.CELL_SIZE//3, self.CELL_SIZE//3))
        self.curr_icon = None
        self.curr_icon_collaborator = None
        self.question1_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/question1.png"),(self.CELL_SIZE*2//3, self.CELL_SIZE*2//3))
        self.question2_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/question2.png"),(self.CELL_SIZE*2//3, self.CELL_SIZE*2//3))
        self.question3_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/question3.png"),(self.CELL_SIZE*2//3, self.CELL_SIZE*2//3))
        self.pit_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/stopped.png"),(self.CELL_SIZE, self.CELL_SIZE))
        self.stop_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/stopped.png"),(self.CELL_SIZE//3, self.CELL_SIZE//3))
        self.accident_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/mad.png"),(self.CELL_SIZE*2//3, self.CELL_SIZE*2//3))
        #self.head_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/snake.png"),(self.CELL_SIZE, self.CELL_SIZE))
        #self.body_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/body.png"),(self.CELL_SIZE, self.CELL_SIZE))
        self.punch_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/scary_tree.png"),(self.CELL_SIZE, self.CELL_SIZE))
        self.curr_head = [0,0]
        self.last_head = [0,0]
        self.curr_head_collaborator = [0,0]
        self.last_head_collaborator = [0,0]
        self.internal_padding = self.CELL_SIZE // 5
        self.text_font = pygame.font.Font("robotaxi_calibration/fonts/gyparody_hv.ttf", int(23*(self.CELL_SIZE/40.0)))
        self.num_font = pygame.font.Font("robotaxi_calibration/fonts/gyparody_tf.ttf", int(36*(self.CELL_SIZE/40.0))) 
        self.marker_font =  pygame.font.Font("robotaxi_calibration/fonts/OpenSans-Bold.ttf", int(12*(self.CELL_SIZE/40.0)))
        pygame.display.set_caption('Robotaxi Calibration')

        info = StreamInfo("Robotaxi_Calibration", "Markers", 1, 0, "string", "myuid000")
        self.outlet = StreamOutlet(info)

    def set_icon_scheme(self, idx):
        scheme = self.car_schemes[idx]
        self.south = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/"+scheme+"_south.png"),(self.CELL_SIZE, self.CELL_SIZE-5))
        self.north = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/"+scheme+"_north.png"),(self.CELL_SIZE, self.CELL_SIZE-5))        
        self.east = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/"+scheme+"_east.png"),(self.CELL_SIZE, self.CELL_SIZE-5))
        self.west = pygame.transform.flip(self.east,1,0)

    def set_icon_scheme_collaborator(self, idx):
        scheme = self.car_schemes[idx]
        self.south_collaborator = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/"+scheme+"_south.png"),(self.CELL_SIZE, self.CELL_SIZE-5))
        self.north_collaborator = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/"+scheme+"_north.png"),(self.CELL_SIZE, self.CELL_SIZE-5))        
        self.east_collaborator = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/"+scheme+"_east.png"),(self.CELL_SIZE, self.CELL_SIZE-5))
    ...
    def render(self):
        ...
        self.screen.fill(Colors.SCREEN_BACKGROUND)
        num_font = pygame.font.Font("robotaxi_calibration/fonts/gyparody_tf.ttf", int(24*(self.CELL_SIZE/40.0)))
        if self.collaborating_agent is not None:
            ...
            for event in pygame.event.get():
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_SPACE:
                        self.pause = False
                        if self.frame_num == 0:
                            pygame.mixer.music.load("robotaxi_calibration/sound/background1.mp3") 
    ...
    def run_episode(self):
        ...
        if is_human_agent: 
            while not self.selected:
                ...
                small_text_font = pygame.font.Font("robotaxi_calibration/fonts/gyparody_hv.ttf", int(22*(self.CELL_SIZE/40.0)))  
                ...
                smaller_text_font = pygame.font.Font("robotaxi_calibration/fonts/gyparody_hv.ttf", int(16*(self.CELL_SIZE/40.0))) 
                ...
                for scheme_idx in range(len(self.car_schemes)):
                    ...
                    car_icon = pygame.transform.scale(pygame.image.load("robotaxi_calibration/icon/"+scheme+"_south.png"),(self.CELL_SIZE, self.CELL_SIZE-5))
                    cell_coords = pygame.Rect(
        ...
        self.render()
        start_text_font = pygame.font.Font("robotaxi_calibration/fonts/gyparody_hv.ttf", int(42*(self.CELL_SIZE/40.0))) 
            ...
            if timestep_timed_out or human_made_move:
                ...
                if not is_human_agent:
                    ...
                    try:
                        ...
                        smaller_text_font = pygame.font.Font("robotaxi_calibration/fonts/gyparody_hv.ttf", int(36*(self.CELL_SIZE/40.0))) 
