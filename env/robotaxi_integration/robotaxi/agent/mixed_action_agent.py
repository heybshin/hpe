...
from robotaxi_integration.gameplay.entities import ALL_SNAKE_ACTIONS, CellType
from robotaxi_integration.agent import ValueIterationAgent
    ...
    def __init__(self, schedule=[[1.0,1.0,4.0]], total_steps=200, grid_size=8, env=None, level_file=None):
        self.reward_mappings = [
            { # go for good fruit
                ...
                CellType.SNAKE_HEAD: 0,
                CellType.SNAKE_BODY: 0,
                CellType.GOOD_EVENT: -1,
                CellType.BAD_EVENT: 6,
                CellType.LAVA: -5,
                CellType.EMPTY: 0,
                CellType.PIT: 0,
                CellType.WALL: -100,
