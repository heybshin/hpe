...
from robotaxi_integration.robotaxi.gameplay.entities import (CellType, SnakeAction, SnakeDirection, ALL_SNAKE_DIRECTIONS, Point)
...
class PyGameGUI:
    ...
    def __init__(self, q_rcv, q_send, save_frames=False, field_size=8, test=False, mode=None):
        ...
        info = StreamInfo("Robotaxi navigation", "Markers", 1, 0, "string", "myuid000")

        # next make an outlet
        self.outlet = StreamOutlet(info)

        pygame.display.set_caption('Robotaxi Navigation')
    ...
    def triangle_pressed_callback(self):
        ...
        if self.running and (self.event_type is not None) and (not self.button_pressed):
            ...
            if self.event_type == "WrongDestination":
    ...
    def circle_pressed_callback(self):
        ...
        if self.running and (self.event_type is not None) and (not self.button_pressed):
            ...
            self.q_send.put(get_screenshot(self.screen, 3))
            if self.event_type == "RightDestination":
                result = TimestepResult(observation=self.env.get_observation(), reward=10, is_episode_end=False)
                self.env.record_timestep_stats(result, 0)
                self.button_pressed_value = 10
            else:
    ...
    def cross_pressed_callback(self):
        ...
        if self.running and (self.event_type is not None) and (not self.button_pressed):
            ...
            self.q_send.put(get_screenshot(self.screen, 3))
            if self.event_type in ["pedestrian_accident", 'vehicle_accident']:
    ...
    def render_scoreboard(self, score, time_elapsed, reward):
        ...
        if self.display_time:
            ...
            text = ("Navigation", str('{:02.0f}:{:02.0f}:{:02.0f}'.format(hours, minutes, seconds)))
            # print(time_elapsed)
            disp_text = self.text_font.render(text[0], True, (0, 0, 0))
    ...
    def render_traffic_lights(self, traffic_lights_pos_dict, time):
        ...
        # if 0 < time % (90/3) < 10/3:  # NS straight
        #     if 0 <= time % (90/3) and blink:  # Blinking effect during the last 3 seconds
        #         self.screen.blit(self.two_left_red_off_south, traffic_lights_pos_dict['01'])
        #         self.screen.blit(self.two_left_red_off_north, traffic_lights_pos_dict['03'])
        #         self.screen.blit(self.pedestrian_green_off, traffic_lights_pos_dict['06'])
        #         self.screen.blit(self.pedestrian_green_off, traffic_lights_pos_dict['08'])
        ...
        #     self.traffic_light_status['05'] = 1
        #     self.traffic_light_status['07'] = 1
        # if 10/3 <= time % (90/3) < 20/3:  # NS left
        #     if 14/3 <= time % (90/3) and blink:
        #         self.screen.blit(self.two_straight_red_off_north, traffic_lights_pos_dict['03'])
        #         self.traffic_light_status['03'] = 31
        #     else:
        #         self.screen.blit(self.two_straight_red_north, traffic_lights_pos_dict['03'])
        ...
        #     self.traffic_light_status['01'] = 11
        #
        # if 20/3 <= time % (90/3) < 30/3:  # All stop
        #     self.screen.blit(self.two_all_red_south, traffic_lights_pos_dict['01'])
        #     self.screen.blit(self.two_all_red_north, traffic_lights_pos_dict['03'])
        #     self.screen.blit(self.pedestrian_red_north, traffic_lights_pos_dict['06'])
        #     self.screen.blit(self.pedestrian_red_north, traffic_lights_pos_dict['08'])
        ...
        #     self.traffic_light_status['05'] = 1
        #     self.traffic_light_status['07'] = 1
        # if 30/3 <= time % (90/3) < 40/3:  # NS left
        #     if 34/3 <= time % (90/3) and blink:
        #         self.screen.blit(self.two_straight_red_off_south, traffic_lights_pos_dict['01'])
        #         self.traffic_light_status['01'] = 31
        #     else:
        #         self.screen.blit(self.two_straight_red_south, traffic_lights_pos_dict['01'])
        ...
        #     self.traffic_light_status['03'] = 11
        #
        # if 40/3 <= time % (90/3) < 60/3:  # WE straight
        #     if 50/3 <= time % (90/3) and blink:  # Blinking effect during the last 3 seconds
        #         self.screen.blit(self.two_left_red_off_west, traffic_lights_pos_dict['02'])
        #         self.screen.blit(self.two_left_red_off_east, traffic_lights_pos_dict['04'])
        ...
        #     self.traffic_light_status['06'] = 1
        #     self.traffic_light_status['08'] = 1
        # if 60/3 <= time % (90/3) < 70/3:  # WE left
        #     if 64/3 <= time % (90/3) and blink:
        #         self.screen.blit(self.two_straight_red_off_east, traffic_lights_pos_dict['04'])
        #         self.traffic_light_status['04'] = 31
        #     else:
        #         self.screen.blit(self.two_straight_red_east, traffic_lights_pos_dict['04'])
        ...
        #     self.traffic_light_status['02'] = 11
        #
        # if 70/3 <= time % (90/3) < 80/3:  # All stop
        #     self.screen.blit(self.two_all_red_west, traffic_lights_pos_dict['02'])
        #     self.screen.blit(self.two_all_red_east, traffic_lights_pos_dict['04'])
        #     self.screen.blit(self.pedestrian_red_north, traffic_lights_pos_dict['05'])
        #     self.screen.blit(self.pedestrian_red_north, traffic_lights_pos_dict['07'])
        ...
        #     self.traffic_light_status['08'] = 1
        #
        # if 80/3 <= time % (90/3) < 90/3:  # WE left
        #     if 84/3 <= time % (90/3) and blink:
        #         self.screen.blit(self.two_straight_red_off_west, traffic_lights_pos_dict['02'])
        #         self.traffic_light_status['02'] = 31
        #     else:
        #         self.screen.blit(self.two_straight_red_west, traffic_lights_pos_dict['02'])
        ...
        ### SECOND INTERSECTION
        if 0/3 < time % (33/3) < 10/3:  # NS straight
            if 7/3 <= time % (33/3) and blink:  # Blinking effect during the last 3 seconds
        ...
        if (10/3 <= time % (33/3) < 13/3) or (30/3 <= time % (33/3) < 33/3):  # All stop
            ...
            self.traffic_light_status['14'] = 1
            self.traffic_light_status['15'] = 1
        if 13/3 <= time % (33/3) < 23/3:  # WE straight
            if 20/3 <= time % (33/3) and blink:  # Blinking effect during the last 3 seconds
            ...
            self.traffic_light_status['13'] = 1
            self.traffic_light_status['15'] = 1
        if 23/3 <= time % (33/3) < 30/3:  # WE left
            if 27/3 <= time % (33/3) and blink:
        ...
        if 10/3 <= time % (33/3) < 17/3:  # WE left and straight
            if 14/3 <= time % (33/3) and blink:
            ...
            self.traffic_light_status['20'] = 1
            self.traffic_light_status['21'] = 1
        if 17/3 <= time % (33/3) < 18/3:  # All stop
            self.screen.blit(self.single_red, traffic_lights_pos_dict['16'])
            self.screen.blit(self.single_red, traffic_lights_pos_dict['17'])
            self.screen.blit(self.single_red, traffic_lights_pos_dict['18'])
            self.screen.blit(self.pedestrian_red_north, traffic_lights_pos_dict['19'])
            ...
            self.traffic_light_status['20'] = 1
            self.traffic_light_status['21'] = 1
        if 18/3 <= time % (33/3) < 25/3:
            if 22/3 <= time % (33/3) and blink:
            ...
            self.traffic_light_status['17'] = 1
            self.traffic_light_status['18'] = 1
        if 25/3 <= time % (33/3) < 33/3:
            if 30/3 <= time % (33/3) and blink:
        ...
        if 0 < time % (33/3) < 10/3:  # NS straight
            if 7/3 <= time % (33/3) and blink:  # Blinking effect during the last 3 seconds
        ...
        if (10/3 <= time % (33/3) < 13/3) or (30/3 <= time % (33/3)):  # All stop
            self.screen.blit(self.single_red, traffic_lights_pos_dict['22'])
    ...
    def render(self, agent_idx=None, counter=None, head_update=False):
        ...
        self.screen.blit(disp_text, (self.screen_size[0] - 6.45 * self.CELL_SIZE, self.CELL_SIZE * (3 - 0.4) + 70))
        disp_num = num_font.render("-5  /", True, (0, 0, 0))
        self.screen.blit(disp_num, (self.screen_size[0] - 5 * self.CELL_SIZE, self.CELL_SIZE * (4 - 0.4) + 70))
        self.screen.blit(self.square_icon, (self.screen_size[0] - 3.5 * self.CELL_SIZE, self.CELL_SIZE * (4 - 0.4) + 70))

        text = "Wrong Destination"
        # print(time_elapsed)
        disp_text = self.text_font.render(text, True, (0, 0, 0))
        self.screen.blit(disp_text, (self.screen_size[0] - 6.45 * self.CELL_SIZE, self.CELL_SIZE * 5 + 70))
        ...
        disp_num = num_font.render("-5  /", True, (0, 0, 0))
        self.screen.blit(disp_num, (self.screen_size[0] - 5 * self.CELL_SIZE, self.CELL_SIZE * 6 + 70))
        self.screen.blit(self.triangle_icon, (self.screen_size[0] - 3.5 * self.CELL_SIZE, self.CELL_SIZE * 6 + 70))

        text = "Right Destination"
        # print(time_elapsed)
        disp_text = self.text_font.render(text, True, (0, 0, 0))
        self.screen.blit(disp_text, (self.screen_size[0] - 6.45 * self.CELL_SIZE, self.CELL_SIZE * (7 + 0.4) + 70))
        ...
        disp_num = num_font.render("-5  /", True, (0, 0, 0))
        self.screen.blit(disp_num, (self.screen_size[0] - 5 * self.CELL_SIZE, self.CELL_SIZE * (8 + 0.4) + 70))
        self.screen.blit(self.circle_icon, (self.screen_size[0] - 3.5 * self.CELL_SIZE, self.CELL_SIZE * (8 + 0.4) + 70))



        text = "Accident"
        disp_text = self.text_font.render(text, True, (0, 0, 0))
        self.screen.blit(disp_text, (self.screen_size[0] - 6.45 * self.CELL_SIZE, self.CELL_SIZE * (10.5 - 0.5) + 70))
        accident_icon = pygame.transform.scale(self.accident_icon,
                                               tuple([int(1.2 * x) for x in self.accident_icon.get_size()]))
        self.screen.blit(accident_icon, (self.screen_size[0] - 2.1 * self.CELL_SIZE, self.CELL_SIZE * (10.2 - 0.5) + 40))
        self.screen.blit(self.west[1], (self.screen_size[0] - 1.6 * self.CELL_SIZE, self.CELL_SIZE * (10.2 - 0.5) + 70))
        self.screen.blit(self.west[0], (self.screen_size[0] - 1.2 * self.CELL_SIZE, self.CELL_SIZE * (10.2 - 0.5) + 70))

        accident_icon = pygame.transform.scale(self.accident_icon,
                                               tuple([int(1.2 * x) for x in self.accident_icon.get_size()]))
        self.screen.blit(accident_icon, (self.screen_size[0] - 4 * self.CELL_SIZE, self.CELL_SIZE * (10.2 - 0.5) + 40))
        self.screen.blit(self.man1_icon_west, (self.screen_size[0] - 4 * self.CELL_SIZE, self.CELL_SIZE * (10.2 - 0.5) + 65))
        self.screen.blit(self.west[0], (self.screen_size[0] - 3.2 * self.CELL_SIZE, self.CELL_SIZE * (10.2 - 0.5) + 70))
        disp_num = num_font.render("-10  /", True, (0, 0, 0))
        self.screen.blit(disp_num, (self.screen_size[0] - 5 * self.CELL_SIZE, self.CELL_SIZE * (12 - 0.5) + 80))
        self.screen.blit(self.cross_icon, (self.screen_size[0] - 3.5 * self.CELL_SIZE, self.CELL_SIZE * (12 - 0.5) + 80))
    ...
    def transition_animation(self, x_v, y_v, x0_v, y0_v, x_p, y_p, x0_p, y0_p, interpolate_idx, counter):
        ...
        for i in range(len(self.env.pedestrians)):
            ...
            # if self.not_pickup or not self.head_to_destination or (self.env.pedestrians[i].lock and not self.env.pedestrians[i].destination) or self.pickup_countdown_pedestrian:  # hide passenger icon if on car
            if not (self.head_to_destination and self.env.pedestrians[i].destination and not self.pickup_countdown_pedestrian):
                self.screen.blit(self.env.pedestrians[i].curr_icon, imm_coords)
                if self.env.pedestrians[i].destination:
                    # self.screen.blit(self.thought_bubble_icon, imm_coords.move(70, -80))
                    attribute_name = f"thought_{self.env.pedestrians[i].destination}_icon"
                    icon = getattr(self, attribute_name)
                    self.screen.blit(icon, imm_coords.move(70, -80))
                if self.env.pedestrians[i].lock and self.env.pedestrians[i].destination:
                    attribute_name = f"thought_{self.env.pedestrians[i].destination}_icon"
                    icon = getattr(self, attribute_name)
                    self.screen.blit(icon, imm_coords.move(70, -80))
                #     self.screen.blit(self.thought_car_icon, imm_coords.move(70, -20))
                ...
                #     color = Colors.GREEN
                #
                # if self.env.pedestrians[i].destination and self.env.pedestrians[i].lock:
                #     color = Colors.BLUE
                #
        ...
        for i in range(len(self.env.vehicles)):
            ...
            if imm_coords == self.last_pos_vehicle[i]:
                self.stuck_vehicle[i] += 1
            else:
                self.stuck_vehicle[i] = 0
            self.last_pos_vehicle[i] = imm_coords
            ...
            if self.action_vehicle[i] == 2 and self.env.vehicles[i].direction == SnakeDirection.EAST and not self.is_in_the_lane(coord=(x0_v[i], y0_v[i])):
                self.screen.blit(north_right[curr_turn_img_idx], imm_coords)
            elif self.action_vehicle[i] == 1 and self.env.vehicles[i].direction == SnakeDirection.WEST and not self.is_in_the_lane(coord=(x0_v[i], y0_v[i])):
                self.screen.blit(north_left[curr_turn_img_idx], imm_coords)
            elif self.action_vehicle[i] == 1 and self.env.vehicles[i].direction == SnakeDirection.NORTH and not self.is_in_the_lane(coord=(x0_v[i], y0_v[i])):
                self.screen.blit(east_left[curr_turn_img_idx], imm_coords)
            elif self.action_vehicle[i] == 2 and self.env.vehicles[i].direction == SnakeDirection.NORTH and not self.is_in_the_lane(coord=(x0_v[i], y0_v[i])):
                self.screen.blit(west_right[curr_turn_img_idx], imm_coords)
            elif self.action_vehicle[i] == 2 and self.env.vehicles[i].direction == SnakeDirection.SOUTH and not self.is_in_the_lane(coord=(x0_v[i], y0_v[i])):
                self.screen.blit(east_right[curr_turn_img_idx], imm_coords)
            elif self.action_vehicle[i] == 1 and self.env.vehicles[i].direction == SnakeDirection.SOUTH and not self.is_in_the_lane(coord=(x0_v[i], y0_v[i])):
                self.screen.blit(west_left[curr_turn_img_idx], imm_coords)
            elif self.action_vehicle[i] == 1 and self.env.vehicles[i].direction == SnakeDirection.EAST and not self.is_in_the_lane(coord=(x0_v[i], y0_v[i])):
                self.screen.blit(south_left[curr_turn_img_idx], imm_coords)
            elif self.action_vehicle[i] == 2 and self.env.vehicles[i].direction == SnakeDirection.WEST and not self.is_in_the_lane(coord=(x0_v[i], y0_v[i])):
        ...
        if (interpolate_idx == 1) and (self.trialends_countdown_rounds == 19):
            if self.event_type in ["pedestrian_accident", 'vehicle_accident']:
                print("E 9 Accident")
                self.outlet.push_sample(["E 9"])
                self.reward_vehicle = self.env.rewards["accident"]
                self.event_scoreboard = -10
                self.timestep_result = self.env.timestep_vehicle(agent_index=i, rwd=self.reward_vehicle, action=self.action_vehicle[i])
    ...
    def interact_traffic_lights_vehicles(self, action, agent_idx):
        ...
        # print("Flag: ", flag)
        if flag:
            if (np.random.rand() < 0) and (not self.env.vehicles[agent_idx].pause):
    ...
    def call_pickup_car(self, agent_idx):

        current_head = self.env.pedestrians[agent_idx].head  # last head
        current_head = (current_head[1], current_head[0])
        pickup_car_idx = None
        for idx, lane in enumerate(LANE_PICKUP):
            if lane[0][0] <= current_head[0] <= lane[1][0] and lane[0][1] <= current_head[1] <= lane[1][1]:
                pickup_car_idx = idx

        success = self.env.new_agent_vehicle(pickup_car_idx)
        # print("Pickup Car Generation: ", success)
        if success:
            self.pickup_vehicle_found = True

            self.post_action_head_list.append(None)
            self.action_vehicle.append(None)
            self.pickup_vehicle.append(True)
            self.speed_vehicle.append(self.normal_update_interval)
            self.stuck_vehicle.append(0)
            self.last_pos_vehicle.append(None)
    ...
    def solve_pickup2destination_path(self, agent_idx):
        ...
        if self.not_pickup:
            random_key = 'stadium'
            dest_head = BUILDING_POS_PARKING[random_key]
            dest_direction = BUILDING_POS_PARKING_DIRECTION[random_key]
            print("Pedestrian Destination: ", des, ", Go To: ", random_key)
        elif self.gotowrong_des:
            keys_without_des = [key for key in BUILDING_POS_PARKING if key != des]
            self.wrong_des = random.choice(keys_without_des)
            dest_head = BUILDING_POS_PARKING[self.wrong_des]
            dest_direction = BUILDING_POS_PARKING_DIRECTION[self.wrong_des]
            print("Pedestrian Destination: ", des, ", Go To: ", self.wrong_des)
        else:
            dest_head = BUILDING_POS_PARKING[des]
            dest_direction = BUILDING_POS_PARKING_DIRECTION[des]
            print("Pedestrian Destination: ", des, ", Go To: ", des)

        dest_head = (dest_head[1], dest_head[0])

        solution = pathfinding((curr_head, curr_direction), (dest_head, dest_direction), agent='vehicle')
        if not solution:
            print("No solution found for the path")
    ...
    def solve_pickup_path_pedestrian(self, agent_idx):
        ...
        dest_head = (int(np.random.choice(np.arange(dest_head1[0], dest_head2[0] + 1))), int(np.random.choice(np.arange(dest_head1[1], dest_head2[1] + 1))))
        while (dest_head[0] == curr_head[0]) and (dest_head[1] == curr_head[1]):
            dest_head = (int(np.random.choice(np.arange(dest_head1[0], dest_head2[0] + 1))),
                         int(np.random.choice(np.arange(dest_head1[1], dest_head2[1] + 1))))

        if dest_head[0] < curr_head[0] and dest_head[1] == curr_head[1]:
            self.env.pedestrians[agent_idx].direction = SnakeDirection.NORTH
        if dest_head[0] > curr_head[0] and dest_head[1] == curr_head[1]:
            self.env.pedestrians[agent_idx].direction = SnakeDirection.SOUTH
        if dest_head[1] < curr_head[1] and dest_head[0] == curr_head[0]:
            self.env.pedestrians[agent_idx].direction = SnakeDirection.WEST
        if dest_head[1] > curr_head[1] and dest_head[0] == curr_head[0]:
            self.env.pedestrians[agent_idx].direction = SnakeDirection.EAST

        if 10 <= dest_head[0] <= 13 and dest_head[1] == 4:
            dest_direction_A = SnakeDirection.SOUTH
            dest_direction_B = SnakeDirection.NORTH
        if dest_head[0] == 9 and 11 <= dest_head[1] <= 12:
            dest_direction_A = SnakeDirection.EAST
            dest_direction_B = SnakeDirection.WEST
        if 11 <= dest_head[0] <= 14 and dest_head[1] == 10:
            dest_direction_A = SnakeDirection.NORTH
            dest_direction_B = SnakeDirection.SOUTH

        if dest_head[0] == 15 and 12 <= dest_head[1] <= 13:
            dest_direction_A = SnakeDirection.WEST
            dest_direction_B = SnakeDirection.EAST
        if dest_head[0] == 19 and 11 <= dest_head[1] <= 12:
            dest_direction_A = SnakeDirection.EAST
            dest_direction_B = SnakeDirection.WEST
        if 11 <= dest_head[0] <= 14 and dest_head[1] == 14:
            dest_direction_A = SnakeDirection.NORTH
            dest_direction_B = SnakeDirection.SOUTH
        if 11 <= dest_head[0] <= 14 and dest_head[1] == 17:
            dest_direction_A = SnakeDirection.NORTH
            dest_direction_B = SnakeDirection.SOUTH

        curr_direction = self.env.pedestrians[agent_idx].direction

        solution_A = pathfinding((curr_head, curr_direction), (dest_head, dest_direction_A), agent='pedestrian')
        solution_B = pathfinding((curr_head, curr_direction), (dest_head, dest_direction_B), agent='pedestrian')

        # choose the shorter path
        if solution_A and solution_B:
            if len(solution_A[1]) < len(solution_B[1]):
                return solution_A[1]
            else:
                return solution_B[1]
        else:
    ...
    def how_far_from_pedestrian(self, agent_idx):
        for i in range(len(self.env.pedestrians)):
            if self.env.pedestrians[i].lock and self.env.pedestrians[i].destination:
                p_pos = self.env.pedestrians[i].head
        ...
        dis = np.sqrt((p_pos[0] - curr_head[0]) ** 2 + (p_pos[1] - curr_head[1]) ** 2)
        if dis < self.pick_dist: self.pick_dist = dis
        if dis > self.pick_dist and self.pick_dist_flag:
            # print("going away")
            self.pick_dist_flag = False

            self.event_type = "NotPickUp"
            print("E 6 Pickup Error")
            self.outlet.push_sample(["E 6"])
            self.reward_vehicle = self.env.rewards["violation"]
            self.event_scoreboard = -5
            self.receive_send_rumble()

    def stuck_detection(self):
        vehicle_counter = 0
        # print(self.stuck_vehicle)
        for i in range(len(self.env.vehicles)):
            if self.stuck_vehicle[i] // self.intermediate_frames > 50:
                # print("Vehicle {} is stuck".format(i))
                vehicle_counter += 1
        if vehicle_counter > 3:
            return True
        return False
    ...
    def agent_generation(self, snake):
        for interpolate_idx in range(10):
            ...
            self.render_scoreboard(self.env.stats.sum_episode_rewards, pygame.time.get_ticks() - self.pause_time,
                                   self.accident_scoreboard + self.event_scoreboard)
    ...
    def run_episode(self, episode_num):
        ...
        self.speed_vehicle = [self.normal_update_interval] * len(self.env.vehicles)
        ...
        self.stuck_vehicle = [0] * len(self.env.vehicles)
        self.last_pos_vehicle = [None] * len(self.env.vehicles)
        ...
        taxi_round = np.random.randint(10)  # randomize after a certain round to take taxi
        taxi_pedestrian = np.random.randint(6)  # choose who to take taxi
        ...
        self.wrong_des = None
        self.gotowrong_des = False
        self.not_pickup_counter = 0
        self.pick_dist = 100000
        self.pick_dist_flag = True
        self.event_scoreboard = 0
        self.accident_scoreboard = 0
        ...
        if np.random.rand() < 0.3:
            self.not_pickup = True
            print("*******Refuse Pickup*******")
        else:
            self.not_pickup = False
            if np.random.rand() < 0.5:
                self.gotowrong_des = True
        ...
        while self.running:
            # if self.stuck_detection(): self.trialends_countdown = True

            if self.visual_feedback_v is not None: visual_feedback_countdown_rounds_v -= 1
            if self.visual_feedback_p is not None: visual_feedback_countdown_rounds_p -= 1
            ...
            if self.event_lock: violation_lock_countdown_rounds -= 1
            ...
            if episode_start:
                ...
                episode_start = False
            elif (pygame.time.get_ticks() - self.pause_time) % 3 == 0 and len(self.env.vehicles) < 10:  # every 5 seconds generate a new agent

                if counter % self.normal_update_interval == 0:
            ...
            # if counter % 10 == 0:  # make sure not the in the middle of the movement
            ...
            if timestep_timed_out:
                ...
                for agent_idx in range(len(self.env.vehicles)):
                    if not self.env.vehicles[agent_idx].lock and self.trialends_countdown_rounds > 4:
                        if self.pickup_vehicle[agent_idx]:
                            if self.not_pickup and not self.destination_path_vehicle and self.taskdone_countdown_vehicle == -1:
                                self.head_to_destination = True
                                self.destination_path_vehicle = self.solve_pickup2destination_path(agent_idx)

                            elif not self.pickup_path_vehicle and not self.head_to_destination and not self.taxi_service_done:
                            ...
                            elif not self.destination_path_vehicle and self.head_to_destination and self.taskdone_countdown_vehicle == -1:
                                self.destination_path_vehicle = self.solve_pickup2destination_path(agent_idx)

                            if self.not_pickup: self.how_far_from_pedestrian(agent_idx)

                        if counter % self.speed_vehicle[agent_idx] == 0:
                            if self.pickup_vehicle[agent_idx]:
                                if self.pickup_countdown_vehicle:
                                    self.pickup_countdown_vehicle -= 1
                                    self.pickup_countdown_pedestrian -= 1
                                    continue
                                if self.taskdone_countdown_vehicle != 0 and self.taskdone_countdown_vehicle != -1:
                                    self.taskdone_countdown_vehicle -= 1
                                    continue

                                # if not self.not_pickup and np.random.rand() < 0.1 and counter % 2 == 0:
                                #     old_speed = self.speed_vehicle[agent_idx]
                                #     # if old_speed == 1:
                                #     #     self.speed_vehicle[agent_idx] = 2
                                #     if old_speed == 2:
                                #         self.speed_vehicle[agent_idx] = 1
                                #         print("Change to sport mode")
                            ...
                            # self.action_vehicle[agent_idx], switch_lane_by_force = self.validate_traffic_rule_vehicles(self.action_vehicle[agent_idx], agent_idx)

                            if self.pickup_vehicle[agent_idx]:
                                if self.pickup_path_vehicle:
                                    # self.action_vehicle[agent_idx] = self.pickup_path_vehicle[0]
                                    action = self.pickup_path_vehicle[0]
                                if self.destination_path_vehicle and (self.head_to_destination or self.not_pickup):
                                    # self.action_vehicle[agent_idx] = self.destination_path_vehicle[0]
                                    action = self.destination_path_vehicle[0]
                            ...
                            if (self.pickup_path_vehicle or self.destination_path_vehicle) and self.pickup_vehicle[agent_idx]:
                                redlight_force = 0
                                accident_force = 0
                            ...
                            if not wait4greenlight and not (collide_w_agents[0] or collide_w_agents[1]):
                                ...
                                if self.pickup_path_vehicle and self.pickup_vehicle[agent_idx]:
                                    ...
                                    if not self.pickup_path_vehicle:
                                        print("N 1 Pickup Success")
                                        self.outlet.push_sample(["N 1"])
                                        self.head_to_destination = True
                                        self.pickup_countdown_vehicle = 2
                                        self.pickup_countdown_pedestrian = 2
                                        # self.env.vehicles[agent_idx].pause = True
                                elif self.destination_path_vehicle and self.pickup_vehicle[agent_idx]:
                                    self.action_vehicle[agent_idx] = self.destination_path_vehicle.pop(0)
                                    if self.not_pickup: self.not_pickup_counter += 1
                                    if self.not_pickup_counter > 11:  # end now
                                        self.taskdone_countdown_vehicle = 0
                                        # self.trialends_countdown_rounds = 0
                                        self.trialends_countdown = True
                                    if not self.destination_path_vehicle:
                                        self.taskdone_countdown_vehicle = 3
                                else:
                                    self.action_vehicle[agent_idx] = action

                                self.post_action_head_list[agent_idx] = self.post_action_head_adjustment(self.action_vehicle[agent_idx], agent_idx)
                                ...
                                if self.timestep_result.is_episode_end and self.env.stats.termination_reason in ['hit_wall', 'hit_own_body']:
                                    ...
                                    self.agent2pop_vehicle.append(agent_idx)
                ...
                for i in range(len(self.agent2pop_vehicle) - 1, -1, -1):
                    self.env.vehicles.pop(self.agent2pop_vehicle[i])
                    self.post_action_head_list.pop(self.agent2pop_vehicle[i])
                    self.speed_vehicle.pop(self.agent2pop_vehicle[i])
                    self.action_vehicle.pop(self.agent2pop_vehicle[i])
                    self.pickup_vehicle.pop(self.agent2pop_vehicle[i])
                    self.stuck_vehicle.pop(self.agent2pop_vehicle[i])
                    self.last_pos_vehicle.pop(self.agent2pop_vehicle[i])
                ...
                for agent_idx in range(len(self.env.pedestrians)):
                    if not self.env.pedestrians[agent_idx].lock and self.trialends_countdown_rounds > 4:
                        if counter >= taxi_round and agent_idx == taxi_pedestrian and self.env.pedestrians[agent_idx].curr_head:
                            if des2rm == 0:
                                ...
                                des_candidate = [key for key in BUILDING_POS_PARKING if key != des2rm]
                                des = random.choice(des_candidate)
                                self.env.pedestrians[agent_idx].destination = des
                                self.original_destination = des
                        ...
                        if self.pickup_pedestrian[agent_idx]:
                            if self.pickup_path_pedestrian is None:
                                self.pickup_path_pedestrian = self.solve_pickup_path_pedestrian(agent_idx)

                        if counter % 8 == 0:
                            if self.is_on_the_zebra_crossing_pedestrian(coord=self.env.pedestrians[agent_idx].curr_head):
                        ...
                        if counter % self.speed_pedestrian[agent_idx] == 0:
                            if self.is_on_the_pickup_area(agent_idx) and self.env.pedestrians[agent_idx].destination and not self.pickup_path_pedestrian and not self.taxi_service_done:  # waiting for pickup
                            # if self.env.pedestrians[agent_idx].destination and self.pickup_pedestrian[agent_idx] and not self.pickup_path_pedestrian:  # waiting for pickup
                                ...
                                self.env.pedestrians[agent_idx].lock_pos = pygame.Rect(
                                    5 + self.CELL_SIZE * self.env.pedestrians[agent_idx].curr_head[0],
                                    5 + self.CELL_SIZE * self.env.pedestrians[agent_idx].curr_head[1],
                                    self.CELL_SIZE,
                                    self.CELL_SIZE
                                )
                            ...
                            if not self.keep_flag[agent_idx]:  # if is waiting for green light, then keep the action unchanged
                                ...
                                if self.pickup_path_pedestrian and self.pickup_pedestrian[agent_idx]:
                                    action = self.pickup_path_pedestrian[0]
                    ...
                    elif self.taxi_service_done and self.env.pedestrians[agent_idx].lock and self.env.pedestrians[agent_idx].destination:
                        if not self.not_pickup:
                            if self.wrong_des:
                                self.env.pedestrians[agent_idx].destination = self.wrong_des
                                self.event_type = "WrongDestination"
                                print("E 7 Goal Error")
                                self.outlet.push_sample(["E 7"])
                                self.reward_vehicle = self.env.rewards["violation"]
                                self.event_scoreboard = -5
                                self.receive_send_rumble()
                                ...
                                self.event_type = "RightDestination"
                                print("N 2 Goal Success")
                                self.outlet.push_sample(["N 2"])
                                self.reward_vehicle = self.env.rewards["violation"]
                                self.event_scoreboard = -5
                                # self.receive_send_rumble()
                            ...
                            self.env.pedestrians[agent_idx].direction = BUILDING_POS_PARKING_DIRECTION[self.env.pedestrians[agent_idx].destination]
                            self.env.field_pedestrian.update_snake_footprint(Point(self.env.pedestrians[agent_idx].last_head[0], self.env.pedestrians[agent_idx].last_head[1]), self.env.pedestrians[agent_idx].head)
                            ...
                            self.env.pedestrians[agent_idx].destination = self.original_destination
                        ...
                        if counter % self.normal_update_interval == 0:
                            self.call_pickup_car(agent_idx)
            ...
            if self.running:
                ...
                for interpolate_idx in range(self.intermediate_frames):
                    ...
                    pygame.display.set_caption(
                        f'Robotaxi Navigation [Score: {score:01d}]   |   [Steps Remaining: {time_remaining:01d}]')
                ...
                if self.trialends_countdown:
                    smaller_text_font = pygame.font.Font("robotaxi_integration/fonts/gyparody_hv.ttf", int(22 * (self.CELL_SIZE / 40.0)))
                    disp_text = smaller_text_font.render("Round Finished", True, (220, 220, 220))
                    self.screen.blit(disp_text, (self.CELL_SIZE * 23 + 50, self.CELL_SIZE * 20))
    ...
    def compare_bounding_boxes(self, array1, array2):
        ...
        for i in range(len(array1)):
            for j in range(i + 1, len(array1)):
                if calculate_overlap_area(array1[i], array1[j]) and (self.pickup_vehicle[i] or self.pickup_vehicle[j]):
        ...
        for i in range(len(array1)):
            for j in range(len(array2)):
                if calculate_overlap_area(array1[i], array2[j]) and self.pickup_vehicle[i]:
                # if calculate_overlap_area(array1[i], array2[j]):
