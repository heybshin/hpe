...
from robotaxi_integration.gameplay.entities import (Point, Field, CellType, RobotaxiDirection, ALL_ROBOTAXI_DIRECTIONS, ROBOTAXI_GROW, WALL_WARP)
...
class Colors:
    ...
    CELL_TYPE = {
        ...
        CellType.GOOD_EVENT: np.random.randint(20, 150, size=3) ,
        CellType.BAD_EVENT:  np.random.randint(80, 250, size=3),
...
def parse_command_line_args(args):
    ...
    parser = argparse.ArgumentParser(
        description='Replay recorded 20*20 robotaxi_integration game from log.'
    )
